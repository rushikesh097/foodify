            ...
            <div className="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
              <div className="font-sans">
                ...
                <p className="text-sm md:text-base font-normal text-gray-600">
                  {props.article.date} {props.article.time}
                </p>
              </div>

              <p className="py-6 flex-wrap">{props.article.description}</p>
            </div>

            <div className="mt-3">
              {props.userId === props.article.userid && (
                <Link
                  className="ml-6 w-3/2 mt-10 p-2.5  text-white bg-green-600 rounded-md outline-none ring-offset-2 ring-green-500 focus:ring-2 font-semibold"
                  to="/editarticle"
                >
                  Edit Article
                </Link>
